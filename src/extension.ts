...
export function activate(context: vscode.ExtensionContext) {
	...
	colorPickerStatusBarItem.command = COMMANDS.COLOR_PICKER;
	colorPickerStatusBarItem.text = "$(paintbrush) Colors";
			...
			async (message) => {
				switch (message.command) {
					case 'updateColors':
						...
						// Refresh open preview panel if it exists
	...
	context.subscriptions.push(helloWorldDisposable, previewDisposable, colorPickerDisposable);
}
 ...
 * @param currentBgColor Current background color from configuration
 * @param currentTextColor Current text color from configuration
 * @returns HTML string for the color picker webview
 */
